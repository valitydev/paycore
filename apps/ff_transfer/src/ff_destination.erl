...
-spec apply_event(prg_machine:event_id(), prg_machine:timestamp(), event(), ff_maybe:'maybe'(destination_state())) ->
    destination_state().
apply_event(_EventID, _Timestamp, Ev, Destination) ->
    apply_event(Ev, Destination).
