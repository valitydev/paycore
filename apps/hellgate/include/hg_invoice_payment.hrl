...
-record(st, {
    ...
    terminal_affinities :: undefined | [dmsl_customer_thrift:'TerminalAffinity'()],
    route_affinity = false :: boolean(),
    affinity_ttl :: dmsl_domain_thrift:'RoutingAffinityTtl'() | undefined,
