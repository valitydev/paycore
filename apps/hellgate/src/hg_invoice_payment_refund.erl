...
do_process(finished, _Refund) ->
    {done, {[], prg_machine_action:new()}}.

process_refund_cashflow(Refund) ->
    Action = prg_machine_action:set_timeout(0, prg_machine_action:new()),
        ...
        {finished, ?session_failed(Failure)} ->
            case check_retry_possibility(Failure, Refund) of
                ...
                fatal ->
                    ...
                    {next, {Events1 ++ RollbackStarted, prg_machine_action:set_timeout(0, Action)}}
            end;
        _ ->
            {next, {Events1, Action}}
    end.
...
process_accounter(Refund) ->
    ...
    {done, {[?refund_status_changed(?refund_succeeded())], prg_machine_action:new()}}.
...
process_failure(Refund) ->
    ...
    {done, {Events, prg_machine_action:new()}}.
...
retry_session(Action, Timeout) ->
    ...
    NewAction = prg_machine_action:set_timer({timeout, Timeout}, Action),
    {NewEvents, NewAction}.
